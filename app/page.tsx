            ...
            {[
              ...
              <motion.div
                ...
                className={`
                  ...
                  ${color === 'yellow' ? 'border-yellow-400 hover:border-yellow-300' : ''}
                  ${color === 'red' ? 'border-red-600 hover:border-red-500' : ''}
                  ${color === 'blue' ? 'border-blue-600 hover:border-blue-500' : ''}
                `}
              >
                ...
                <p className="text-white/90">Access {title.toLowerCase()} and detailed analysis</p>
              </motion.div>
            ))}
          </div>
